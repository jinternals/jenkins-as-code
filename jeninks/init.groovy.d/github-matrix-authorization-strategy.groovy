...
authz_strategy_config = [
        ...
        role_permissions: [
                ...
                contributor: ['Overall Read', 'Job Read', 'View Read','Job Build','Job Cancel']
        ]
]
...
if(config.jenkins.auth.github.matrixAuthorization == false){
   return;
}
...
config.jenkins.auth.github.matrix.each
        { credential ->
